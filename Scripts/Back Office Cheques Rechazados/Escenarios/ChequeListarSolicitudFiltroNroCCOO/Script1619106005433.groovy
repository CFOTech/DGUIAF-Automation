...
WebUI.waitForElementPresent(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/input_Nro. CCOO_form-control custom-width-13 ng-untouched ng-valid ng-dirty'), 
    5)

WebUI.sendKeys(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/input_Nro. CCOO_form-control custom-width-13 ng-untouched ng-valid ng-dirty'), 
    '1122')
...
WebUI.waitForElementPresent(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/td_1122'), 
    5)

WebUI.verifyElementText(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/td_1122'), ' 1122 ')
