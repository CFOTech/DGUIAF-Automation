...
ResponseObject response = WS.sendRequest(findTestObject('ObjectsWSApi/BUIAPI/BUIAPIGenerar(Parametrizado)', [('DomainURL') : GlobalVariable.url_BUIAPI
            ...
            , ('documento') : '12345678', ('email') : 'juanca@yopmail.com', ('direccion') : '', ('localidad') : 'Capital Federal'
...
WS.verifyElementPropertyValue(response, 'Message', "Error al guardar BUI. Errores: La dirección del contribuyente no puede estar vacía.; ")