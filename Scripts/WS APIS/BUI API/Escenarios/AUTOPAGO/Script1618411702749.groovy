...
ResponseObject response = WS.sendRequest(findTestObject('ObjectsWSApi/BUI API - Generar', [('DomainURL') : GlobalVariable.url_BUIAPI])) //Print de control//print(response.getResponseText())
...
ResponseObject response2 = WS.sendRequest(findTestObject('ObjectsWSApi/BUI API - GetToken', [('buiId') : ResponseParsed]))
...
WebUI.callTestCase(findTestCase('WS APIS/BUI API/Escenarios/BUI API - VerificaciondeAutoPago'), [('Url_AutoPago') : urlAutopago], FailureHandling.STOP_ON_FAILURE)
