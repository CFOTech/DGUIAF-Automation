...
WebUI.callTestCase(findTestCase('BUI WEB/Genericos/Boleta - Completar formulario - Datos del contribuyente'), [('dni') : '12345678'
        , ('apellidoYNombre') : '', ('correoElectronico') : 'jcarlos@test.com', ('direccion') : '123', ('piso') : '1', ('departamento') : '2'
        , ('localidad') : 'caba', ('codigoPostal') : '1234'], FailureHandling.STOP_ON_FAILURE)
