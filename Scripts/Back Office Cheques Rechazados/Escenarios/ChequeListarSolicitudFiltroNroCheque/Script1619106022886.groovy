...
WebUI.waitForElementPresent(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/input_Nro. de Cheque_form-control custom-width-13 ng-untouched ng-valid ng-dirty'), 
    5)

WebUI.sendKeys(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/input_Nro. de Cheque_form-control custom-width-13 ng-untouched ng-valid ng-dirty'), 
    '101112')
...
WebUI.waitForElementPresent(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/td_101112'), 
    5)

WebUI.verifyElementText(findTestObject('ObjectsBackoOfficeChequesRechazados/ListarFiltrarChequesRechazados/td_101112'), 
    '101112')
