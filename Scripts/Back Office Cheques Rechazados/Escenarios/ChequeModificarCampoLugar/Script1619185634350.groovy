...
WebUI.click(findTestObject('ObjectsBackoOfficeChequesRechazados/ChequesRechazadosModificar/span_Preeliminar_glyphicon glyphicon-pencil'))

WebUI.clearText(findTestObject('ObjectsBackoOfficeChequesRechazados/ChequesRechazadosSolicitud/input_Lugar Emisin_placeEmi'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('ObjectsBackoOfficeChequesRechazados/ChequesRechazadosSolicitud/input_Lugar Emisin_placeEmi'), 
    'Neverland')
...
WebUI.click(findTestObject('ObjectsBackoOfficeChequesRechazados/ChequesRechazadosModificar/a_Preeliminar_btn btn-success btn-xs ng-star-inserted'))

WebUI.waitForElementPresent(findTestObject('ObjectsBackoOfficeChequesRechazados/ChequesRechazadosSolicitud/input_Lugar Emisin_placeEmi'), 
    5)

WebUI.verifyElementText(findTestObject('ObjectsBackoOfficeChequesRechazados/ChequesRechazadosSolicitud/input_Lugar Emisin_placeEmi'), 
    '')
