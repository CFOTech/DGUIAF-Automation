...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta02'))
...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta03'))
...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta04'))
...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta05'))
...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta06'))
...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta07'))

WebUI.verifyTextPresent('El servicio está habilitado las 24, todos los días.', false)

WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta08'))
...
WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta09'))

WebUI.verifyTextPresent('Recordá que para dudas y reclamos comunicarse con el 147', false)

WebUI.click(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta10'))
...
WebUI.sendKeys(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/inputBuscarPregunta'), 'pago')

WebUI.verifyElementClickable(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta01'))

WebUI.verifyElementClickable(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta05'))

WebUI.verifyElementClickable(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta06'))

WebUI.verifyElementClickable(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta07'))

WebUI.verifyElementClickable(findTestObject('ObjectsPortal/00-Preguntas Frecuentes/optionPregunta09'))
