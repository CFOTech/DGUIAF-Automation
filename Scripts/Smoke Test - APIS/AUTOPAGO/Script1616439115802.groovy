...
ResponseObject response = WS.sendRequest(findTestObject('Smoke Test/BUI API - Generar', [('DomainURL') : GlobalVariable.url_BUIAPI])) //Print de control//print(response.getResponseText())
...
WebUI.callTestCase(findTestCase('Smoke Test - APIS/BUI API - VerificaciondeAutoPago'), [('Url_AutoPago') : urlAutopago], FailureHandling.STOP_ON_FAILURE)
