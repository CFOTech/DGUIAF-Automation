...
ResponseObject responseIdGenerado = WS.sendRequest(findTestObject('ObjectsWSApi/BUI API - Generar'))
...
ResponseObject JsonBoleta = WS.sendRequest(findTestObject('ObjectsWSApi/BUI API - getBoletaMasPago', [('idBoleta') : IdGeneradoParsed]))
